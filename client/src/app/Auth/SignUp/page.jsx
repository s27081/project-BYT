  ...
  const onSubmit = async (event) => {
    ...
    return (
        <div className={styles.container}>
          ...
          <div className={styles.formContainer}>
            <form onSubmit={onSubmit}>
              <div className={styles.inputBox}>
                ...
                <input type="text" placeholder="email" value={email} onChange={e => setEmail(e.target.value)}  className={styles.inputField} />
              </div>
              ...
              <div className={styles.inputBox}>
                <FaLock style={{ color: '#FFFFFF', fontSize: '24px', transform: 'translateY(40px)'}} />
                <input type="password" placeholder="Repeat Password" value={repeatedPassword} onChange={e => setRepeatedPassword(e.target.value)}  className={styles.inputField} />
              </div>
          ...
          <div className={styles.registerText} style={{top: '68%'}}>Sign IN</div>
          </Link>
          <Link href="/">
            <Image
