      ...
      <div className={styles.rootContainer}>
        <div style={{ transform: "translate3d(-580px, -60px,0px)" }}>
          ...
          <div className={styles.mainText}>
            With our e-learning platform, teaching Python becomes easier than
            ever. Intuitive tools allow you to track your students' progress,
            while clear lessons and practical exercises ensure effective
            understanding of the material. Give your students the opportunity to
            learn programming in a friendly environment!
          </div>
        ...
        <div
          ...
          style={{ transform: "translateX(780px)" }}
        >
