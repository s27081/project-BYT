...
(1, 'Task 1', 'Write a function `sum_numbers(a, b)` that takes two numbers as arguments and returns their sum.'),
(2, 'Task 2', 'Write a function `is_even(n)` that takes an integer and returns `True` if the number is even or `False` otherwise..'),
(3, 'Task 3', 'Write a function `numbers that returns an array with numbers from 1 to 10.'),
